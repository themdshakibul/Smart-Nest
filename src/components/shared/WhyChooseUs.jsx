  ...
  const features = [
    {
      ...
      description:
        "Every property is physically inspected to ensure it meets our strict quality guidelines.",
    },
    {
      icon: <CreditCard className="w-8 h-8 text-champagne" />,
      title: "Secure Payments",
      description:
        "Encrypted escrow services for all transactions, protecting both tenants and owners.",
    },
    {
      icon: <Headset className="w-8 h-8 text-champagne" />,
      title: "24/7 Concierge",
      description:
        "Personalized support for maintenance, transport, and lifestyle requests anytime.",
    },
    {
      icon: <KeyRound className="w-8 h-8 text-champagne" />,
      title: "Exclusive Access",
      description:
        "Get early access to off-market properties and members-only events.",
    },
  ];
      ...
      <div className="container mx-auto px-6 md:px-12">
        ...
        >
          ...
          <p className="font-body text-base md:text-lg text-muted max-w-xl mx-auto">
            We provide more than just a place to live. We provide a lifestyle
            managed with absolute precision and care.
          </p>
        </motion.div>
