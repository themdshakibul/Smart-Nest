...
export default function Footer() {
  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-6 md:px-12 py-16 grid grid-cols-1 md:grid-cols-4 gap-8">
        {/* Brand Column */}
        <motion.div variants={itemVariants} className="flex flex-col">
          ...
          <p className="font-body text-sm text-white/70 mb-8 max-w-xs leading-relaxed">
            Connecting discerning tenants with the world's most exceptional
            living spaces.
          </p>
        ...
        <motion.div variants={itemVariants}>
          ...
          <ul className="space-y-4">
            <li>
              <Link
                className="font-body text-sm text-white/70 hover:text-champagne transition-colors"
                href="/"
              >
                About Us
              </Link>
      ...
      <div className="max-w-[1280px] mx-auto px-6 md:px-12 py-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-4 text-white/50">
        ...
        <div className="flex gap-8">
          <Link
            className="font-body text-xs tracking-wide hover:text-white transition-colors"
            href="/"
          >
            Privacy
          </Link>
